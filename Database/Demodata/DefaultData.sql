...
INSERT INTO [PM].[PM_USER_DATA]
	SELECT 'AGG_SERVICE_ACCOUNT','AGG_SERVICE_ACCOUNT',SubString(master.dbo.fn_varbintohexstr(HashBytes('SHA2_256', 'demouser')),3,32),NULL,NULL,NULL,NULL,NULL,'A'
	UNION ALL SELECT 'demo','i2b2 User',SubString(master.dbo.fn_varbintohexstr(HashBytes('SHA2_256', 'demouser')),3,32),NULL,NULL,NULL,NULL,NULL,'A'
	UNION ALL SELECT 'i2b2','i2b2 Admin',SubString(master.dbo.fn_varbintohexstr(HashBytes('SHA2_256', 'demouser')),3,32),NULL,NULL,NULL,NULL,NULL,'A'
