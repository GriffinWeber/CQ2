Mozilla Public License ("Software License")
Version 2.0

This Software License covers downloads from the Clinical Query 2 project ("CQ2")

Your downloading, copying, modifying, displaying, distributing or use of any software and/or data from CQ2 (collectively, the "Software") constitutes acceptance of all of the terms and conditions of this Software License. If you do not agree to such terms and conditions, you have no right to download, copy, modify, display, distribute or use the Software. 
